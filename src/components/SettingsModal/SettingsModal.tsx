...
import { Settings, Eye, EyeOff, Check, LogOut, Lock, DownloadCloud, Bot, Palette, ToggleLeft, User, Sparkles, GraduationCap, RotateCcw, Bell, Code2 } from 'lucide-react';
...
type SettingsTab = 'ai' | 'theme' | 'education' | 'features' | 'account' | 'developer';
...
export function SettingsModal({ open, onOpenChange }: { open?: boolean; onOpenChange?: (open: boolean) => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      />
      <DialogContent className="sm:max-w-[750px] max-h-[85vh] overflow-hidden flex flex-col p-0 gap-0" style={{ height: '580px' }}>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    { id: 'dark', label: '暗夜星空', sub: 'Dark', from: 'from-[#09090b]', to: 'to-[#18181b]', border: 'border-[#6366f1]' },
                    { id: 'dream', label: '绮梦幻境', sub: 'Dream', from: 'from-[#7c3aed]', to: 'to-[#d946ef]', border: 'border-[#7c3aed]' },
                  ].map((t) => (
                    <div
                      key={t.id}
                    ...
                    >
                      ...
                      <h4 className="font-bold text-slate-800 text-center text-sm">{t.label}</h4>
