...
export const buildPrompt = (form: FormState, isRegeneration: boolean = false) => {
  ...
  const systemPrompt = `你是一位顶尖的小学体育教研员，精通《国家学生体质健康标准》和现行体育课程设置要求。
请你根据我提供的条件，生成一份结构严谨、科学合理、可落地实施的【小学体育教案】。
...
2. 负荷适配：根据年级特性调整运动量。低年级（1-2）侧重情境化趣味性，中年级（3-4）侧重基本技能，高年级（5-6）侧重专项技能和实战对抗。
