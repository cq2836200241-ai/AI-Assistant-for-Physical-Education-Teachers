...
6. 课题边界：课题必须属于体育与健康课程范围。如果课题明显是语文、数学、英语、音乐、美术、科学、普通食品、闲聊词、人物地点或其他非体育内容，不得强行改编成体育活动，也不得生成教案。
7. 取消队形示意图：不需要设计或绘制任何队形站位示意图图表。${!includeTeacherActivity ? '\n8. 取消教师活动：根据用户定制要求，教学过程中**绝对不能**包含"教师活动"的相关描述。' : ''}
